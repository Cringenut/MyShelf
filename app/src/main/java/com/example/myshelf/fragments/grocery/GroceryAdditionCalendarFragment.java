...
public class GroceryAdditionCalendarFragment extends Fragment implements GroceryCalendarGridViewAdapter.OnCalendarClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        calendarViewModel.setInitialDate(mainViewModel.getGroceryToAdd().getGroceryAdditionDate());
        calendarViewModel.setSelectedDate(mainViewModel.getGroceryToAdd().getGroceryAdditionDate());
        ...
        binding.btnConfirm.setOnClickListener(v -> {
            mainViewModel.setGroceryAdditionDate(calendarViewModel.getSelectedDate().getValue());
